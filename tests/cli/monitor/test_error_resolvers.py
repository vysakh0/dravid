...
class TestErrorResolver(unittest.TestCase):
    ...
    def test_monitoring_handle_error_with_dravid_apply_fix(self, mock_executor, mock_call_api):
        # Setup mocks
    ...
    @patch('drd.cli.monitor.error_resolver.call_dravid_api')
    def test_monitoring_handle_error_with_dravid_no_apply_fix(self, mock_call_api):
        # Setup mocks
        mock_call_api.return_value = [
    ...
    @patch('drd.cli.monitor.error_resolver.call_dravid_api')
    def test_monitoring_handle_error_with_dravid_parse_error(self, mock_call_api):
        # Setup mocks

...
class TestUtilityFunctions(unittest.TestCase):
    ...
    @patch('builtins.open', new_callable=mock_open, read_data="Test project guidelines")
    def test_fetch_project_guidelines_with_file(self, mock_file, mock_exists):
        guidelines = fetch_project_guidelines("/fake/path")
        self.assertEqual(guidelines, "Test project guidelines")

    @patch('os.path.exists', return_value=False)
    def test_fetch_project_guidelines_without_file(self, mock_exists):
        guidelines = fetch_project_guidelines("/fake/path")
